...
/***/ "./src/screenEdgeBounce/screenEdgeBounceComponent.js":
/*!***********************************************************!*\
  !*** ./src/screenEdgeBounce/screenEdgeBounceComponent.js ***!
  \***********************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (/* binding */ ScreenEdgeBounceComponent)\n/* harmony export */ });\n/* harmony import */ var _ecs_component__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../ecs/component */ \"./src/ecs/component.js\");\n\n\nclass ScreenEdgeBounceComponent extends _ecs_component__WEBPACK_IMPORTED_MODULE_0__[\"default\"] {\n    constructor(bodyComponent, graphicsComponent) {\n        super();\n        this.bodyComponent = bodyComponent;\n        this.graphicsComponent = graphicsComponent;\n    }\n}\n\n//# sourceURL=webpack:///./src/screenEdgeBounce/screenEdgeBounceComponent.js?");

/***/ }),

/***/ "./src/screenEdgeBounce/screenEdgeBounceSystem.js":
/*!********************************************************!*\
  !*** ./src/screenEdgeBounce/screenEdgeBounceSystem.js ***!
  \********************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (/* binding */ ScreenEdgeBounceSystem)\n/* harmony export */ });\n/* harmony import */ var _ecs_system__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../ecs/system */ \"./src/ecs/system.js\");\n/* harmony import */ var _screenEdgeBounceComponent__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./screenEdgeBounceComponent */ \"./src/screenEdgeBounce/screenEdgeBounceComponent.js\");\n/* harmony import */ var _vec2__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../vec2 */ \"./src/vec2.js\");\n/* harmony import */ var _config__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../config */ \"./src/config.js\");\n\n\n\n\n\nclass ScreenEdgeBounceSystem extends _ecs_system__WEBPACK_IMPORTED_MODULE_0__[\"default\"] {\n    constructor() {\n        super();\n        this.width = _config__WEBPACK_IMPORTED_MODULE_3__[\"default\"].width;\n        this.height = _config__WEBPACK_IMPORTED_MODULE_3__[\"default\"].height;\n    }\n\n    update() {\n        for(const component of this.components) {\n            const bodyComponent = component.bodyComponent;\n            const graphicsComponent = component.graphicsComponent;\n            if(bodyComponent.position.x + bodyComponent.radius >= this.width) {\n                let diff = bodyComponent.position.x + bodyComponent.radius - this.width;\n                bodyComponent.position = new _vec2__WEBPACK_IMPORTED_MODULE_2__[\"default\"](bodyComponent.position.x - 2 * diff, bodyComponent.position.y);\n                bodyComponent.velocity = new _vec2__WEBPACK_IMPORTED_MODULE_2__[\"default\"](-bodyComponent.velocity.x, bodyComponent.velocity.y);\n                graphicsComponent.setRandomColor();\n            }\n            if(bodyComponent.position.x - bodyComponent.radius <= 0) {\n                let diff = bodyComponent.position.x - bodyComponent.radius;\n                bodyComponent.position = new _vec2__WEBPACK_IMPORTED_MODULE_2__[\"default\"](bodyComponent.position.x - 2 * diff, bodyComponent.position.y);\n                bodyComponent.velocity = new _vec2__WEBPACK_IMPORTED_MODULE_2__[\"default\"](-bodyComponent.velocity.x, bodyComponent.velocity.y);\n                graphicsComponent.setRandomColor();\n            }\n            if(bodyComponent.position.y + bodyComponent.radius > this.height) {\n                let diff = bodyComponent.position.y + bodyComponent.radius - this.height;\n                bodyComponent.position = new _vec2__WEBPACK_IMPORTED_MODULE_2__[\"default\"](bodyComponent.position.x, bodyComponent.position.y - 2 * diff);\n                bodyComponent.velocity = new _vec2__WEBPACK_IMPORTED_MODULE_2__[\"default\"](bodyComponent.velocity.x, -bodyComponent.velocity.y);\n                graphicsComponent.setRandomColor();\n            }\n        }\n    }\n\n    createScreenEdgeBounceComponent(bodyComponent, graphicsComponent) {\n        const component = new _screenEdgeBounceComponent__WEBPACK_IMPORTED_MODULE_1__[\"default\"](bodyComponent, graphicsComponent);\n        this.components.push(component);\n        return component;\n    }\n}\n\n//# sourceURL=webpack:///./src/screenEdgeBounce/screenEdgeBounceSystem.js?");
